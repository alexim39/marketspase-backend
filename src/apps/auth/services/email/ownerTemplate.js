  ...
  <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #eee;">
    ...
    <div style="padding:30px 20px;">
      ...
      <div style="text-align:center;margin:30px 0;">
        <a href="https://admin.marketSpase.com" style="display:inline-block;padding:14px 28px;background:#c2185b;color:#fff;text-decoration:none;border-radius:8px;font-weight:bold;font-size:15px;">View User in Admin Dashboard</a>
      </div>
