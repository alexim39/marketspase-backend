...
import { DashboardActivityGateway } from '../../application/ports/dashboard-activity.gateway.js';
...
export class MongooseDashboardActivityGateway extends DashboardActivityGateway {
