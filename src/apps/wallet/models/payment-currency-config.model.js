...
const supportedCurrencySchema = new mongoose.Schema({
  ...
  flutterwaveChargeSupported: { type: Boolean, default: false },
  flutterwaveTransferSupported: { type: Boolean, default: false },
  ...
  supportedCurrencies: {
    ...
    default: () => ([
      ...
      },
      {
        ...
        paystackChargeSupported: false,
        paystackTransferSupported: false,
        flutterwaveChargeSupported: true,
        flutterwaveTransferSupported: true,
        sortOrder: 5,
      },
      {
        code: 'ZAR',
