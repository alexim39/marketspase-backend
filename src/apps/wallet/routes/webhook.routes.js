...
import { handleDepositWebhook } from "../services/deposit-webhook.js";

const router = express.Router();


// Important: raw body must be used for signature validation
router.post(
  '/paystack/deposit',
  express.raw({ type: "application/json" }),
  (req, res) => handleDepositWebhook(req, res)
)
...
//     if (!secret) {
//       console.error('Missing PAYSTACK_WEBHOOK_SECRET or PAYSTACKTOKEN env');
