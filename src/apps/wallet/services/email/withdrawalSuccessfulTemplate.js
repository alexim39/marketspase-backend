  ...
  <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #eee;">
    ...
    <div style="padding:30px 20px;">
      ...
      <p style="font-size:16px;line-height:1.6;margin:0 0 24px;">
        Your withdrawal request has been processed successfully. The funds should reflect in your bank account shortly.
      </p>
      ...
      <div style="background:#f0fff4;padding:20px;border-radius:8px;margin-bottom:24px;">
        ...
        <table style="width:100%;font-size:14px;line-height:1.5;">
          <tr>
            ...
            <td style="padding:8px 0;color:#2d3748;text-align:right;">N${userData.amount.toLocaleString()}</td>
          </tr>
          <tr>
            <td style="padding:8px 0;color:#4a5568;"><strong>Processing Fee:</strong></td>
            <td style="padding:8px 0;color:#2d3748;text-align:right;">N${userData.fee.toLocaleString()}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="padding:8px 0;color:#2d3748;text-align:right;">N${userData.newBalance.toLocaleString()}</td>
          </tr>
          <tr>
      ...
      <div style="background:#f7fafc;padding:16px;border-radius:8px;margin:24px 0;">
        <p style="font-size:14px;line-height:1.5;margin:0;color:#4a5568;">
          <strong>Tip:</strong> Keep building momentum with quality campaigns, product promotions, and traffic that converts well for brands and storefronts.
        </p>
      </div>

      <div style="text-align:center;margin:30px 0;">
        <a href="https://marketspase.com/dashboard/campaigns" style="display:inline-block;padding:14px 28px;background:#673ab7;color:#fff;text-decoration:none;border-radius:6px;font-weight:bold;">Explore New Opportunities</a>
      </div>
      ...
      <p style="font-size:15px;margin-top:30px;">Keep growing!<br><strong>The MarketSpase Team</strong></p>
    </div>
