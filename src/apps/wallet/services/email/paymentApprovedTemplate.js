  ...
  <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #eee;">
    ...
    <div style="padding:30px 20px;">
      ...
      <p style="font-size:16px;line-height:1.6;margin:0 0 24px;">
        Your wallet has been successfully funded. You're ready to launch click-based campaigns, support storefront growth, or cover your next marketing activity inside MarketSpase.
      </p>
      ...
      <div style="background:#f0fff4;padding:20px;border-radius:8px;margin-bottom:24px;">
        ...
        <table style="width:100%;font-size:14px;line-height:1.5;">
          <tr>
            ...
            <td style="padding:8px 0;color:#2d3748;text-align:right;">N${userData.amount}</td>
          </tr>
          <tr>
          ...
          <tr>
            ...
            <td style="padding:8px 0;color:#2d3748;text-align:right;">N${userData.newBalance}</td>
          </tr>
          <tr>
      ...
      <p style="font-size:15px;line-height:1.6;">
        Need help deciding what to do next? Contact us at
        <a href="mailto:support@marketspase.com" style="color:#673ab7;text-decoration:none;">support@marketspase.com</a>
      </p>

      <p style="font-size:15px;margin-top:30px;">Onward and upward!<br><strong>The MarketSpase Team</strong></p>
    </div>
