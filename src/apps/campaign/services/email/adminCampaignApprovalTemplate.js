  ...
  <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #eee;">
    ...
    <div style="padding:30px 20px;">
      ...
      <p style="font-size:16px;line-height:1.6;margin:0 0 24px;">
        A new click-based campaign has been submitted and needs admin review before it can go live for promoters.
      </p>
      ...
      <div style="background:#fffaf0;padding:20px;border-radius:8px;margin-bottom:24px;">
        ...
        <table style="width:100%;font-size:14px;line-height:1.5;">
          ...
          <tr>
            ...
            <td style="padding:8px 0;color:#2d3748;text-align:right;">N${campaignData.budget}</td>
          </tr>
          <tr>
      ...
      <div style="background:#e6fffa;padding:16px;border-radius:8px;margin:24px 0;">
        <p style="font-size:14px;line-height:1.5;margin:0;color:#234e52;">
          <strong>Action Required:</strong> Review this campaign within 24 hours so promoter matching and click delivery can start on time.
        </p>
      </div>
      ...
      <p style="font-size:15px;line-height:1.6;">This is an automated notification. You're receiving it because you're an admin on MarketSpase.</p>
