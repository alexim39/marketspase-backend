// services/email/campaignRejectedTemplate.js
...
<body style="margin:0;padding:0;background-color:#fafafa;font-family:Arial, sans-serif;color:#2d3748;">
  <div style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #eee;">
    ...
    <div style="padding:30px 20px;">
      ...
      <p style="font-size:16px;line-height:1.6;margin:0 0 24px;">After reviewing your campaign, we're unable to approve it at this time. Don't worry - your funds have been refunded to your wallet.</p>
      ...
      <div style="background:#fed7d7;padding:20px;border-radius:8px;margin-bottom:24px;">
        ...
        <table style="width:100%;font-size:14px;line-height:1.5;">
          ...
          <tr>
            ...
            <td style="padding:8px 0;color:#2d3748;text-align:right;">₦${campaignData.refundAmount.toLocaleString()}</td>
          </tr>
        </table>
      </div>
      ...
      <div style="background:#f7fafc;padding:20px;border-radius:8px;margin-bottom:24px;">
        ...
        <ul style="margin:0;padding-left:20px;font-size:14px;line-height:1.5;">
          ...
          <li>Update your campaign content based on the feedback</li>
      ...
      <p style="font-size:15px;line-height:1.6;">Need help? Our support team is here to assist you at <a href="mailto:support@marketspase.com" style="color:#673ab7;text-decoration:none;">support@marketspase.com</a></p>
