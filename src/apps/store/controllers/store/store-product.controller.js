  ...
  try {
    ...
    try {
      ...
      return res.status(status).json({
        success: false,
        message: status === 404 ? 'Store not found' : 'You do not have permission to view this product',
      });
    }
    ...
    // Transform product with all necessary fields
...
// Add this function if you need to get multiple products for a store
