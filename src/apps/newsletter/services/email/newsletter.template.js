export const newsletterEmailTemplate = (newsletter, user, trackingPixelUrl = null, unsubscribeUrl = null) => {
  ...
  const roleTip = user.role === 'promoter'
    ? 'Complete your profile and focus on quality traffic to unlock stronger campaign matches and payouts.'
    : user.role === 'marketer'
      ? 'Use clear destination links, realistic budgets, and sharp targeting to get better promoter performance.'
  ...
  <div class="container" style="max-width:600px;margin:0 auto;background:#ffffff;border-radius:12px;overflow:hidden;border:1px solid #e2e8f0;">
    ...
    <div class="content" style="padding:30px 25px;">
      ...
      <div style="background:#f7fafc;padding:20px;border-radius:8px;margin:30px 0;text-align:center;">
        ...
        <p style="font-size:15px;color:#718096;margin:0 0 20px;">Visit your dashboard to explore new campaigns, promoted products, storefront activity, or your latest earnings.</p>
    ...
    <div style="background:#1a202c;color:#a0aec0;padding:25px 20px;text-align:center;font-size:13px;">
      <div style="margin-bottom:20px;">
        ...
        <a href="https://wa.me/2349062537816" style="display:inline-block;margin:0 8px;color:#a0aec0;text-decoration:none;" target="_blank">
          <img src="https://cdn-icons-png.flaticon.com/512/124/124027.png" alt="WhatsApp" width="24" height="24" style="border-radius:50%;">
        </a>
      </div>

      <p style="margin:0 0 12px;line-height:1.4;">
        MarketSpase - Powering multi-channel promotion and social commerce
      </p>

      <p style="margin:0 0 20px;font-size:12px;color:#718096;">
        &copy; ${year} MarketSpase. All rights reserved.
      </p>
      ...
      <div style="border-top:1px solid #2d3748;padding-top:20px;">
        ...
        <p style="margin:0;font-size:12px;">
          ${unsubscribeUrl ? `<a href="${unsubscribeUrl}" style="color:#a0aec0;text-decoration:none;margin:0 10px;">Unsubscribe</a> | ` : ''}
...
&copy; ${new Date().getFullYear()} MarketSpase. All rights reserved.
`.trim();
};
